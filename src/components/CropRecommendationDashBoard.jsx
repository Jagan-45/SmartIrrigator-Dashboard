...
export function CropRecommendationDashBoard() {
    ...
    return (
        ...
        <div className="bg-white p-6 rounded shadow-md mt-6">
            ...
            <div className="chocolate-fall-container">
                <div className="chocolate-fall">
                {Array(20).fill(0).map((_, i) => (
                    <i key={i} className="fas fa-chocolate fa-2x text-brown-500 animate-fall" />
                ))}
                </div>
            </div>
            ...
            Your Recommended Crop:
            </h2>
            <p className="text-lg text-center">
            <strong className="text-green-600">{result.prediction}</strong>
            </p>
